...
namespace GestionResidenciaApi.Data
{
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Configure precision for decimal columns to avoid truncation warnings
            modelBuilder.Entity<CuotaAdministracion>().Property(c => c.Valor).HasPrecision(18, 2);
            modelBuilder.Entity<CuotaAdministracion>().Property(c => c.SaldoPendiente).HasPrecision(18, 2);
            // Map DateOnly to SQL date
            
            modelBuilder.Entity<Mantenimiento>().Property(m => m.Costo).HasPrecision(18, 2);
            modelBuilder.Entity<Pago>().Property(p => p.ValorTotal).HasPrecision(18, 2);
            modelBuilder.Entity<PagoDetalle>().Property(pd => pd.ValorAbonado).HasPrecision(18, 2);
            modelBuilder.Entity<ZonaComun>().Property(z => z.ValorHora).HasPrecision(18, 2);
